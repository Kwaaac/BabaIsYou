...
public enum Legend {
     ...
     * Blank
     */
    BLANK('_', Type.ENTITY, "BLANK", ColorPrint.ANSI_RESET, new Color(1f, 1f, 1f), -1, "/Sprites/PLACEHOLDER/placeholder_0_1.png"),
    /**
     * Nouns
     */
    ...
    WATER_NOUN('T', Type.NOUN, "WATER", ColorPrint.ANSI_BLUE, new Color(17, 159, 236), 1, "/Sprites/WATER/noun/text_water_0_1.png"),
    ...
    WATER_ENTITY('t', Type.ENTITY, "WATER", ColorPrint.ANSI_BLUE, new Color(17, 159, 236), 0, "/Sprites/WATER/entity/water_0_1.png"),
    /**
     * Operator
     */
    ...
    SINK('N', Type.PROPERTY, "SINK", ColorPrint.ANSI_BLUE_BACKGROUND, new Color(17, 159, 236), 1, "/Sprites/PROPERTY/SINK/text_sink_0_1.png");
